...
class TestPositionTrading:
    ...
    def test_01_header_button_login(
        ...
        link = page_menu.sub_menu_position_trading_move_focus_click(d, cur_language)
    ...
    def test_06_button_download_on_the_app_store(
        ...
        build_dynamic_arg_v2(self, d, worker_id, cur_language, cur_country, cur_role, prob_run_tc,
                             "11.03.04", "Educations > Menu item [Position Trading]", "06",
    ...
    def test_08_button_explore_web_platform(
        ...
        Language: All. License: All.
        """
        print(f"\n{datetime.now()}   Работает obj {self} с именем TC_11.03.04_08")
        build_dynamic_arg_v2(self, d, worker_id, cur_language, cur_country, cur_role, prob_run_tc,
                             "11.03.04", "Educations > Menu item [Position Trading]",
    ...
    def test_09_create_and_verify_your_account_button_in_block_steps_trading(
        ...
        Language: All. License: All.
        """
        print(f"\n{datetime.now()}   Работает obj {self} с именем TC_11.03.04_09")
        build_dynamic_arg_v2(self, d, worker_id, cur_language, cur_country, cur_role, prob_run_tc,
                             "11.03.04", "Educations > Menu item [Position Trading]",
