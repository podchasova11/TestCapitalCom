...
class TestBasicsOfTrading:
    ...
    #                                 prob_run_tc,
    #                                 "11.01.02",
    #                                 "Education > Menu Item [The basics of trading]",
    #                                 "01",
    ...
    #
    @allure.step("Start test_11.01.02_01 button 'Create_verify_your_account' on the page.")
    def test_11_01_02_01_create_verify_your_account(
            self, worker_id, d, cur_language, cur_country, cur_role, cur_login, cur_password,
            prob_run_tc, cur_time):
        """
