...
class TestSwingTrading:
    ...
    def test_01_header_button_login(
        ...
        """
        print(f"\n\n{datetime.now()}   Работает obj {self} с именем TC_11.03.05_01")

        build_dynamic_arg_v2(self, d, worker_id, cur_language, cur_country, cur_role, prob_run_tc,
                             "11.03.05", "Educations > Menu item [Swing Trading]",
        ...
        link = page_menu.sub_menu_swing_trading_move_focus_click(d, cur_language)
    ...
    def test_02_header_button_trade(
        ...
        Language: All. License: All.
        """
        print(f"\n\n{datetime.now()}   Работает obj {self} с именем TC_11.03.05_02")
        build_dynamic_arg_v2(self, d, worker_id, cur_language, cur_country, cur_role, prob_run_tc,
                             "11.03.05", "Educations > Menu item [Swing Trading]",
    ...
    def test_03_main_banner_start_trading_button(
        ...
        Language: All. License: All.
        """
        print(f"\n{datetime.now()}   Работает obj {self} с именем TC_11.03.05_03")
        build_dynamic_arg_v2(self, d, worker_id, cur_language, cur_country, cur_role, prob_run_tc,
                             "11.03.05", "Educations > Menu item [Swing Trading]",
    ...
    def test_04_main_banner_try_demo_button(
        ...
        Language: All. License: All.
        """
        print(f"\n{datetime.now()}   Работает obj {self} с именем TC_11.03.05_04")
        build_dynamic_arg_v2(self, d, worker_id, cur_language, cur_country, cur_role, prob_run_tc,
                             "11.03.05", "Educations > Menu item [Swing Trading]",
    ...
    def test_05_most_traded_trade_button(
        ...
        Language: All. License: All.
        """
        print(f"\n{datetime.now()}   Работает obj {self} с именем TC_11.03.05_05")
        build_dynamic_arg_v2(self, d, worker_id, cur_language, cur_country, cur_role, prob_run_tc,
                             "11.03.05", "Educations > Menu item [Swing Trading]",
    ...
    def test_06_button_download_on_the_app_store(
        ...
        build_dynamic_arg_v2(self, d, worker_id, cur_language, cur_country, cur_role, prob_run_tc,
                             "11.03.05", "Educations > Menu item [Swing Trading]", "06",
    ...
    def test_07_button_get_it_on_google_play(
        ...
        Language: All. License: All.
        """
        print(f"\n{datetime.now()}   Работает obj {self} с именем TC_11.03.05_07")
        build_dynamic_arg_v2(self, d, worker_id, cur_language, cur_country, cur_role, prob_run_tc,
                             "11.03.05", "Educations > Menu item [Swing Trading]",
    ...
    def test_08_button_explore_web_platform(
        ...
        Language: All. License: All.
        """
        print(f"\n{datetime.now()}   Работает obj {self} с именем TC_11.03.05_08")
        build_dynamic_arg_v2(self, d, worker_id, cur_language, cur_country, cur_role, prob_run_tc,
                             "11.03.05", "Educations > Menu item [Swing Trading]",
    ...
    def test_09_create_and_verify_your_account_button_in_block_steps_trading(
        ...
        Language: All. License: All.
        """
        print(f"\n{datetime.now()}   Работает obj {self} с именем TC_11.03.05_09")
        build_dynamic_arg_v2(self, d, worker_id, cur_language, cur_country, cur_role, prob_run_tc,
                             "11.03.05", "Educations > Menu item [Swing Trading]",
