...
class TestLearningHub:
    ...
    def test_11_01_01_02_header_button_signup(
            self, worker_id, d, cur_language, cur_country, cur_role, cur_login, cur_password,
            prob_run_tc, cur_time):
        """
        Check: Button [Trade]
    ...
    @allure.step("Start test_11.01.01_03 button '1. Create your account' in the block [Steps trading].")
    def test_11_01_01_03_create_your_account(
        ...
        link = build_dynamic_arg_v2(self, d, worker_id, cur_language, cur_country, cur_role, prob_run_tc,
                                    "11.01.01", "Education > Menu Item [Learning hub]",
                                    "03", "Testing button [1. Create your account] in block [Steps trading]")
