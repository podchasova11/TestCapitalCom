...
class GetStartedOnStickyBar(BasePage):
    ...
    def arrange_(self, d, cur_item_link):
        ...
        if self.element_is_visible(CommoditiesPageElements.BUTTON_ON_STICKY_BAR):
    ...
    def element_click(self):
        ...
        button_list = self.browser.find_elements(*CommoditiesPageElements.BUTTON_ON_STICKY_BAR)
