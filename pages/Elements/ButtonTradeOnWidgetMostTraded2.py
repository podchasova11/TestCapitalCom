...
class ButtonTradeOnWidgetMostTradedTest(BasePage):
    ...
    #             # self.browser.back()
    #             test_element2 = AssertClass(self.browser, cur_item_link)
    #             match cur_role:
    #                 case "NoReg":
    #                     test_element2.assert_signup(self.browser, cur_language, cur_role, cur_item_link)
    #                 case "Reg/NoAuth":
    #                     test_element2.assert_login(self.browser, cur_item_link)
